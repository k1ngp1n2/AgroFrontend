...
export default class BasketContacts extends PureComponent {
  ...
  render() {
    ...
    if (jwtToken === '') {
      content = (
        <Fragment>
          <p className='description'>Чтобы продолжить, заполните свои данные</p>
          <input
            type='text'
            id='label_fio'
            name='name'
            ...
            placeholder=' '
          />
          <label className='contact_fio' htmlFor='label_fio'>
          ...
          <input
            ...
            placeholder=' '
          />
          <label className='contact_city' htmlFor='label_city'>
            Город
          </label>
          <input
            type='text'
            ...
            placeholder=' '
          />
          <label className='contact_address' htmlFor='label_address'>
            Адрес доставки
          </label>
          <input
            type='text'
            ...
            placeholder=' '
          />
          <label className='contact_phone' htmlFor='label_phone'>
            Телефон
          </label>
          <input
            type='text'
            ...
            placeholder=' '
          />
          <label className='contact_email' htmlFor='label_email'>
          ...
          <input
            ...
            placeholder=' '
          />
          <label className='contact_password' htmlFor='label_password'>
            Пароль
          </label>
        </Fragment>
      );
