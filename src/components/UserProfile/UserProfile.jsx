        ...
        case buyer:
          content = (
            <Fragment>
              ...
              <span className='profile_address'>Регион: {profile.address}</span>
              <span className='profile_phone'>Телефон: +7-{profile.phone}</span>
      ...
      return (
        <div className='seller_items'>
          ...
          <div className='user_profile_content'>
            ...
            <div className='seller_profile'>{content}</div>
          </div>
        </div>
      );
    }
