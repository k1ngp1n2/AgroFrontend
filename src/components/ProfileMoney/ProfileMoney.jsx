...
export default class ProfileMoney extends PureComponent {
  ...
  sendMoney = () => {
    ...
    fetch(`${serverAddress}/api/member/transactions`, {
      ...
      body: registerJSON,
    }).then(() => itemHandle('profile_account'));
  };
    ...
    return (
      <div className='details_for_pay seller_items'>
        ...
        <input
          ...
          onChange={this.handleChange}
        />
        <label className='item_card_number' htmlFor='label_card_number'>
          Номер карты
        </label>
        <input
          type='text'
          ...
          onChange={this.handleChange}
        />
        <label className='item_day_expire' htmlFor='label_day_expire'>
          Срок действия
        </label>
        <input
          type='text'
          ...
          onChange={this.handleChange}
        />
        <label className='item_ccv' htmlFor='label_ccv'>
          CCV
        </label>
        <input
          type='text'
          ...
          onChange={this.handleChange}
        />
        <label className='item_amount' htmlFor='label_amount'>
