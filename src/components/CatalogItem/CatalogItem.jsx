      ...
      return (
        <div className='catalog_item'>
          <div className='left_info'>
            ...
            <p
              className='item_seller'
              onClick={() => producerHandle(catalogItem.product.producer_id)}
            >
              Производитель: {catalogItem.product.producer_name}
            </p>
          </div>
          <div className='right_info'>
            <img
              src={serverAddress + catalogItem.product.image}
              alt={catalogItem.product.image}
            />
            <p>
              <Button
              ...
              <span className='item_price'>
                {catalogItem.product.price.toLocaleString('ru')} руб. / 1{' '}
                {catalogItem.product.measures}
              </span>
            </p>
            <Button
